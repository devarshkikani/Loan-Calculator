...
class MutualFundsResultScreen extends StatefulWidget {
  final num investment;
  final num returnRate;
  final num time;
  const MutualFundsResultScreen(
      {super.key,
  ...
  @override
  State<MutualFundsResultScreen> createState() =>
      MutualFundsResultScreenState();
}

class MutualFundsResultScreenState extends State<MutualFundsResultScreen> {
